<template>
    <div class="game-interface">
        ...
        <header class="game-header">
            ...
            <div class="user-info">
                <span v-if="currentUser">Bienvenue, {{ currentUser.prenom }} {{ currentUser.nom }}</span>
            ...
            <div v-if="currentView === 'profile'" class="profile-view">
                ...
                <div class="profile-form">
                    <div class="form-group">
                        <label>Nom:</label>
                        <input v-model="currentUser?.nom" disabled />
                    </div>
                    <div class="form-group">
                        <label>Prénom:</label>
                        <input v-model="currentUser?.prenom" disabled />
                    </div>
                    <div class="form-group">
                        <label>Email:</label>
                        <input v-model="currentUser?.email" disabled />
                    </div>
                    <div class="form-group">
                        <label>Âge:</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea v-model="currentUser?.interets"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Préférences de rencontre:</label>
                        <select v-model="currentUser?.preferencesRencontre">
                    ...
                    <div class="form-group">
                        ...
                        <input v-model="currentUser?.disponibilite" type="text" placeholder="Ex: Soirées, Week-ends" />
                    </div>
